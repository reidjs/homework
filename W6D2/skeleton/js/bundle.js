...
View.prototype.exercise5 = function () {
  ...
  $('.square').on('click', function(event){
    console.log();
    alert(event.currentTarget.attributes[1].value)
    // debugger
  })
};
...
View.prototype.exercise6 = function () {
  ...
  $('li').each(function(i){
    // console.log(i);
    $('li')[i].style['background-color'] = window._randomColorString();
...
View.prototype.exercise7 = function(){
  ...
  $('.square').on('mouseover', function(event){
    console.log(event.currentTarget.attributes.style.value);
  });
};
